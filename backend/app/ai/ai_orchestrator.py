...
class AIOrchestrator:
    ...
    async def process_complaint_full(
        ...
        return {
            ...
            "formatted_recommendation": rag_res.get("formatted_recommendation", rag_res.get("recommendation", "")),
            "recommendation_header": rag_res.get("header", "AI GENERATED RECOMMENDATION"),
            "recommendation_disclaimer": rag_res.get("disclaimer", "The agent remains responsible for the final decision."),
